                ...
                <Container className='xl:space-y-10 sm:space-y-8 space-y-6'>
                    ...
                    <section className='grid xl:grid-cols-4 md:grid-cols-3 grid-cols-2 gap-5'>
                        {[
                            ...
                            { id: 5, name: 'Dairy1', img: dairy, bgColor: '#eaf4f4' },
                            { id: 6, name: 'Grains2', img: grains, bgColor: '#FAF9D7', },
                            { id: 7, name: 'Dairy1', img: dairy, bgColor: '#eaf4f4' },
                            { id: 8, name: 'Grains2', img: grains, bgColor: '#FAF9D7', },
